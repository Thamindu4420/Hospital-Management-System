        ...
        private void LoadData()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    // Query to retrieve data from the patient_registration table
                    string query = "SELECT PatientID, FirstName, LastName, TotalBill FROM patient_registration";
