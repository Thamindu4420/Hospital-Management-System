    ...
    public partial class Total_Patients_Report : Form
    {
        ...
        private void DisplayData()
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "SELECT PatientID, FirstName, LastName, Diagnosis FROM patient_registration";
