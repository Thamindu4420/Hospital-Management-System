    ...
    public partial class Total_Doctors_Report : Form
    {
        ...
        private void DisplayData()
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "SELECT DoctorID, FirstName, LastName, RoomNumber FROM doctor_registration";
